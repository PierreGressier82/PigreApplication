...
public class TresFute extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void setTableauJaune() {
        ...
        //ImageView imageJauneLigne1Case4 = findViewById(R.id.ligne1JauneCase4);
        //ImageView imageJauneLigne2Case3 = findViewById(R.id.ligne2JauneCase3);
        //ImageView imageJauneLigne3Case2 = findViewById(R.id.ligne3JauneCase2);
        //ImageView imageJauneLigne4Case1 = findViewById(R.id.ligne4JauneCase1);
        //ImageView imageJauneLigne1Case5 = findViewById(R.id.ligne1JauneCase5);
        //ImageView imageJauneLigne2Case5 = findViewById(R.id.ligne2JauneCase5);
        //ImageView imageJauneLigne3Case5 = findViewById(R.id.ligne3JauneCase5);
        //ImageView imageJauneLigne5Case1 = findViewById(R.id.ligne5JauneCase1);
        //ImageView imageJauneLigne5Case2 = findViewById(R.id.ligne5JauneCase2);
    ...
    private void setTableauBleu()
    {
        ...
        // BLEU
        //ImageView imageBleuLigne1Case1 = findViewById(R.id.ligne1Bleucase1);
        //ImageView imageBleuLigne2Case1 = findViewById(R.id.ligne2bleuCase1);
        //ImageView imageBleuLigne2Case5 = findViewById(R.id.ligne2bleuCase5);
        //ImageView imageBleuLigne3Case5 = findViewById(R.id.ligne3bleuCase5);
        //ImageView imageBleuLigne4Case5 = findViewById(R.id.ligne4bleuCase5);
        //ImageView imageBleuLigne5Case1 = findViewById(R.id.ligne5JauneCase1);
        //ImageView imageBleuLigne5Case2 = findViewById(R.id.ligne5JauneCase2);
        //ImageView imageBleuLigne5Case3 = findViewById(R.id.ligne5JauneCase3);
        //ImageView imageBleuLigne5Case4 = findViewById(R.id.ligne5JauneCase4);
        //ImageView imageJauneLigne5Case1 = findViewById(R.id.ligne5JauneCase1);
        //ImageView imageJauneLigne5Case2 = findViewById(R.id.ligne5JauneCase2);
        //ImageView imageJauneLigne5Case3 = findViewById(R.id.ligne5JauneCase3);
        //ImageView imageJauneLigne5Case4 = findViewById(R.id.ligne5JauneCase4);
